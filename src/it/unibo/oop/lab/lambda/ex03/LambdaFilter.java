...
public final class LambdaFilter extends JFrame {
	...
	private enum Command {
    	...
    	LOWERCASE("Convert to lowercase", a->a.toLowerCase()),
    	CHARSCOUNT("Count the number of chars", a->Integer.toString(a.length())),
    	LINECOUNT("Count the number of lines", a->Long.toString(a.chars().filter(s-> s == '\n').count()+1)),
